...
try:
    ...
    _FA_AVAILABLE = False
    raise Exception("Import face_alignment failed; uncomment this to override")
...
class FaceAligner:
    ...
    def process_single_image(self,
        ...
        image_buffer = self.align_face(image_path)

        # --- Save ---
        try:
            self._save_aligned_image(image_buffer, save_path)
        except Exception as exc:
