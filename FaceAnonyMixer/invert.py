...
def main():
    ...
    parser.add_argument('--batch-size', type=int, default=1, help="set generation batch size")
    ...
    if 'celebahq' in args.dataset:
        dataset = CelebAHQ(root_dir=args.dataset_root, dataset_name=args.dataset)
    ...
    for i_batch, data_batch in enumerate(
        ...
        for i in range(args.batch_size):
            ...
            ## override alignment
            img_aligned = cv2.imread(data_batch[2][i])
